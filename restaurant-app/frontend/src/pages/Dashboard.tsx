        ...
        <div className="grid grid-cols-3 gap-4">
          ...
          <div className="bg-white dark:bg-white/[0.04] dark:border dark:border-white/[0.07] rounded-2xl shadow-sm overflow-hidden">
            <div className="flex items-center justify-between px-5 pt-5 pb-3">
              <div className="flex items-center gap-2"><div className="w-1.5 h-5 rounded-full bg-orange-400" /><p className="text-sm font-semibold text-gray-700 dark:text-slate-200">Aktive Bestellungen</p></div>
            ...
            <div className="px-5 pb-5 space-y-3">
              {letzteBestellungen.length === 0 ? <p className="text-sm text-gray-400 dark:text-slate-500">Keine aktiven Bestellungen.</p>
                : letzteBestellungen.map((b) => (
                  <div key={b.id} className="flex items-center gap-3 p-2 rounded-xl hover:bg-gray-50/80 dark:hover:bg-white/5 transition-colors">
                    <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-slate-100 to-slate-50 dark:from-slate-700 dark:to-slate-800 flex items-center justify-center text-xs font-bold text-slate-500 dark:text-slate-300 ring-1 ring-slate-200/50 dark:ring-white/10">T{b.tisch_nummer}</div>
          ...
          <div className="bg-white dark:bg-white/[0.04] dark:border dark:border-white/[0.07] rounded-2xl shadow-sm overflow-hidden">
            <div className="flex items-center justify-between px-5 pt-5 pb-3">
              <div className="flex items-center gap-2"><div className="w-1.5 h-5 rounded-full bg-blue-400" /><p className="text-sm font-semibold text-gray-700 dark:text-slate-200">Reservierungen heute</p></div>
            ...
            <div className="px-5 pb-5 space-y-3">
              {naechsteReservierungen.length === 0 ? <p className="text-sm text-gray-400 dark:text-slate-500">Keine Reservierungen heute.</p>
                : naechsteReservierungen.map((r) => (
                  <div key={r.id} className="flex items-center gap-3 p-2 rounded-xl hover:bg-gray-50/80 dark:hover:bg-white/5 transition-colors">
                    <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-blue-100 to-blue-50 dark:from-blue-900/40 dark:to-blue-800/30 flex items-center justify-center text-xs font-bold text-blue-600 dark:text-blue-400 ring-1 ring-blue-200/50 dark:ring-blue-500/20">{formatZeit(r.datum)}</div>
