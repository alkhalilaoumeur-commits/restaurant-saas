...
export default function Topbar({ titel, untertitel, aktion }: TopbarProps) {
  ...
  return (
    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-6 sm:mb-8 pb-4 border-b border-gray-100 dark:border-white/10">
      <div>
        <h1 className="text-lg sm:text-[22px] font-heading font-semibold text-gray-900 dark:text-slate-50 tracking-[-0.02em]">{titel}</h1>
